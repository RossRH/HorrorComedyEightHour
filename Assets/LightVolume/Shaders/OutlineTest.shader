Shader "Sprites/Outline"
{
    Properties
    {
        ...
        [HDR][PerRendererData]  _OutlineColor("Outline Color", Color) = (0,0,0,0)
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            fixed4 ComputeFragment(VertexOutput vertexOutput) : SV_Target
            {
                ...
                color.rgb = lerp(color.rgb * 0, outlineColor.rgb * outlineColor.a, shouldDrawOutline);
                color.a = shouldDrawOutline;
